...
const slides: SqueezeSlide[] = [
  ...
  { id: 'team', title: 'มีทีมพร้อมให้คำปรึกษาตลอดทาง', description: 'เริ่มจากทำความเข้าใจธุรกิจของคุณ แล้ววางแนวทางที่เหมาะกับงาน', image: photo('photo-1522071820081-009f0129c71c'), imageAlt: 'ทีมงานร่วมกันวางแผนในสำนักงาน', overlay: mark('พร้อมทำไปด้วยกัน'), action: 'ปรึกษาทีมงาน', href: '#contact' },
]
