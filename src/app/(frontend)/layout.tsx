...
export const metadata: Metadata = {
  title: 'Promptthum — รับทำเว็บไซต์ ครบวงจร ',
  description:
  ...
  return (
    <html lang="th">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Kanit:wght@300;400;500;600;700;800&family=Syne:wght@700&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>{children}</body>
