...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_leads_budget" AS ENUM('3000', '10000', '20000+', 'unspecified');
  CREATE TYPE "public"."enum_leads_status" AS ENUM('new', 'contacting', 'quoted', 'won', 'lost');
  ...
  CREATE TABLE "leads" (
  	...
  	"budget" "enum_leads_budget" DEFAULT 'unspecified',
  	"package_interest" varchar,
  	"message" varchar,
